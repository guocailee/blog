...
!(function (t, e) {
    ...
    for (var t = 1; t < arguments.length; t++) {
      ...
      t % 2
        ? s(Object(o), !0).forEach(function (t) {
            var e, i
            ;(e = n), (i = o[(t = t)]), (t = l(t)) in e ? Object.defineProperty(e, t, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (e[t] = i)
          })
  ...
  function A(e, i) {
    if (e && I(i))
      if (Array.isArray(e) || E(e.length)) for (var t = e.length, n = 0; n < t && !1 !== i.call(e, e[n], n, e); n += 1);
      else
        o(e) &&
      ...
      .forEach(function (t) {
        ...
        yt ||
          ((e = i.listeners) &&
            e[t] &&
            e[t][n] &&
            ((s = e[t][n]), delete e[t][n], 0 === Object.keys(e[t]).length && delete e[t], 0 === Object.keys(e).length) &&
            delete i.listeners),
  ...
  function q(t, e, i, n) {
    ...
    return (
      I(Event) && I(CustomEvent)
        ? (o = new CustomEvent(e, P({ bubbles: !0, cancelable: !0, detail: i }, n)))
    ...
    i = {
      ...
      initViewer: function () {
        var t,
          e = this.options,
          i = this.parent
        e.inline && ((t = { width: Math.max(i.offsetWidth, e.minWidth), height: Math.max(i.offsetHeight, e.minHeight) }), (this.parentData = t)),
      ...
      renderList: function () {
        ...
        n &&
          ...
          (n = n.offsetWidth),
          C(this.list, O({ width: (e = n + t) * this.length - t }, xt({ translateX: (this.viewerData.width - n) / 2 - e * i }))))
      },
      resetList: function () {
        var t = this.list
        ...
        ;(this.imageInitializing = {
          ...
          (t = zt(e, h, function (t, e) {
            var i = t / e,
              ...
              o = c,
              s = u,
              n = ((l.imageInitializing = !1), c < u * i ? (s = c / i) : (o = u * i), (n = E(n) ? n : 0.9), (o = Math.min(o * n, t)), (s = Math.min(s * n, e)), (c - o) / 2),
              a = (u - s) / 2,
              n = { left: n, top: a, x: n, y: a, width: o, height: s, oldRatio: 1, ratio: o / t, aspectRatio: i, naturalWidth: t, naturalHeight: e },
              a = O({}, n)
            h.rotatable && ((n.rotate = d.rotate || 0), (a.rotate = 0)),
              h.scalable && ((n.scaleX = d.scaleX || 1), (n.scaleY = d.scaleY || 1), (a.scaleX = 1), (a.scaleY = 1)),
              (l.imageData = n),
      ...
      renderImage: function (t) {
        var e,
          ...
          n = this.image,
          o = this.imageData
        C(n, O({ width: o.width, height: o.height, marginLeft: o.x, marginTop: o.y }, xt(o))),
          t &&
            ((this.viewing || this.moving || this.rotating || this.scaling || this.zooming) && this.options.transition && L(n, m)
              ? ((e = function () {
    ...
    t = {
      bind: function () {
        ...
        X(e, w, (this.onClick = this.click.bind(this))),
          ...
          t.zoomable && t.zoomOnWheel && X(e, rt, (this.onWheel = this.wheel.bind(this)), { passive: !1, capture: !0 }),
      ...
      unbind: function () {
        ...
        Y(e, w, this.onClick),
          ...
          t.zoomable && t.zoomOnWheel && Y(e, rt, this.onWheel, { passive: !1, capture: !0 }),
    ...
    St = {
      click: function (t) {
        var e = this.options,
          ...
          o = N(n, ht)
        switch (
          (o || 'img' !== n.localName || 'li' !== n.parentElement.localName || (o = N((n = n.parentElement), ht)),
      ...
      dblclick: function (t) {
        t.preventDefault(),
          this.viewed &&
            t.target === this.image &&
            (a && t.isTrusted && clearTimeout(this.doubleClickImageTimeout), this.toggle(t.isTrusted ? t : t.detail && t.detail.originalEvent))
      },
      load: function () {
        var t = this,
        ...
        M(n, p),
          ...
          (n.style.cssText =
            'height:0;' + 'margin-left:'.concat(s.width / 2, 'px;') + 'margin-top:'.concat(s.height / 2, 'px;') + 'max-width:none!important;position:relative;width:0;'),
          this.initImage(function () {
            F(n, G, i.movable),
              F(n, m, i.transition),
              t.renderImage(function () {
                ;(t.viewed = !0), (t.viewing = !1), I(i.viewed) && X(e, z, i.viewed, { once: !0 }), q(e, z, { originalImage: t.images[o], index: o, image: n }, { cancelable: !1 })
              })
          })
      },
      loadImage: function (t) {
        ...
        zt(n, this.options, function (t, e) {
          var t = t / e,
            e = o,
            i = s
          o < s * t ? (a ? (e = s * t) : (i = o / t)) : a ? (i = o / t) : (e = s * t), C(n, O({ width: e, height: i }, xt({ translateX: (o - e) / 2, translateY: (s - i) / 2 })))
        })
      },
      keydown: function (t) {
        var e = this.options
      ...
      pointerdown: function (t) {
        ...
        ;(this.pointerMoved = !1),
          !this.viewed ||
            ...
            this.viewing ||
            this.hiding ||
            (('mousedown' === t.type || ('pointerdown' === t.type && 'mouse' === t.pointerType)) && ((E(n) && 1 !== n) || (E(o) && 0 !== o) || t.ctrlKey)) ||
            (t.preventDefault(),
            t.changedTouches
            ...
            e.zoomOnTouch && e.zoomable && 1 < Object.keys(i).length
              ? (n = c)
              : e.slideOnTouch && ('touch' === t.pointerType || 'touchstart' === t.type) && this.isSwitchable() && (n = j),
      ...
      pointerup: function (t) {
        ...
        t.changedTouches
          ...
          o &&
            (t.preventDefault(), !n.transition || (o !== h && o !== c) || R(this.image, m), (this.action = !1), a) &&
            o !== c &&
            e &&
    ...
    It = {
            ...
            !1 !== q(r, 'hide') &&
              ...
              l.transition && !a
                ? ((n = function t(e) {
                  ...
                  this.viewed && L(t, m) ? (X(t, k, o, { once: !0 }), this.zoomTo(0, !1, null, null, !0)) : o())
                : e())),
          this
        )
      },
      view: function () {
        ...
        if (!(this.hiding || this.played || t < 0 || t >= this.length || (this.viewed && t === this.index))) {
          ...
          A(a.inheritedAttributes, function (t) {
            ...
            !1 === q(s, 'view', { originalImage: this.images[t], index: t, image: m }) ||
              !this.isShown ||
              this.hiding ||
              this.played ||
              ((u = this.items[this.index]) && (M(u, f), u.removeAttribute('aria-selected')),
              R(h, f),
              ...
              X(
                ...
                (e = function () {
                  ...
                  r.innerHTML = T((e = I(e) ? e.call(i, m, t) : ''.concat(d, ' (').concat(t.naturalWidth, ' × ').concat(t.naturalHeight, ')')))
                    ? e
                ...
                abort: function () {
                  Y(s, z, e),
                    m.complete
                      ...
                      : ((m.src = ''), Y(m, y, n), i.timeout && clearTimeout(i.timeout))
                },
              }),
              m.complete
                ? this.load()
      ...
      moveTo: function (t) {
        ...
        if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && s.movable)) {
          ...
          if ((E(t) ? (h = !0) : (t = r), E(i) ? (h = !0) : (i = l), h)) {
            if ((I(s.move) && X(o, 'move', s.move, { once: !0 }), !1 === q(o, 'move', { x: t, y: i, oldX: r, oldY: l, originalEvent: n }))) return this
            ;(a.x = t),
              (a.y = i),
              (a.left = t),
              (a.top = i),
              ...
              this.renderImage(function () {
                ;(e.moving = !1), I(s.moved) && X(o, 'moved', s.moved, { once: !0 }), q(o, 'moved', { x: t, y: i, oldX: r, oldY: l, originalEvent: n }, { cancelable: !1 })
              })
          }
        }
        return this
      ...
      rotateTo: function (t) {
        ...
        if (E((t = Number(t))) && this.viewed && !this.played && n.rotatable) {
          var s = o.rotate
          if ((I(n.rotate) && X(i, 'rotate', n.rotate, { once: !0 }), !1 === q(i, 'rotate', { degree: t, oldDegree: s }))) return this
          ;(o.rotate = t),
            (this.rotating = !0),
            this.renderImage(function () {
              ;(e.rotating = !1), I(n.rotated) && X(i, lt, n.rotated, { once: !0 }), q(i, lt, { degree: t, oldDegree: s }, { cancelable: !1 })
            })
        }
        return this
      },
      ...
      scale: function (t) {
        ...
        if (((t = Number(t)), (i = Number(i)), this.viewed && !this.played && o.scalable)) {
          ...
          if ((E(t) ? (l = !0) : (t = a), E(i) ? (l = !0) : (i = r), l)) {
            if ((I(o.scale) && X(n, 'scale', o.scale, { once: !0 }), !1 === q(n, 'scale', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }))) return this
            ;(s.scaleX = t),
              (s.scaleY = i),
              (this.scaling = !0),
              this.renderImage(function () {
                ;(e.scaling = !1), I(o.scaled) && X(n, 'scaled', o.scaled, { once: !0 }), q(n, 'scaled', { scaleX: t, scaleY: i, oldScaleX: a, oldScaleY: r }, { cancelable: !1 })
              })
          }
        }
        return this
      ...
      zoomTo: function (t) {
        ...
        if (E((t = Math.max(0, t))) && this.viewed && !this.played && (l || c.zoomable)) {
          if ((l || ((l = Math.max(0.01, c.minZoomRatio)), (y = Math.min(100, c.maxZoomRatio)), (t = Math.min(Math.max(t, l), y))), r))
            switch (r.type) {
              case 'wheel':
          ...
          var w,
            ...
            b = y - v,
            x = d.ratio
          if ((I(c.zoom) && X(h, 'zoom', c.zoom, { once: !0 }), !1 === q(h, 'zoom', { ratio: t, oldRatio: x, originalEvent: r }))) return this
          ;(this.zooming = !0),
            r
              ? ((w = {
            ...
            (d.ratio = t),
            this.renderImage(function () {
              ;(e.zooming = !1), I(c.zoomed) && X(h, 'zoomed', c.zoomed, { once: !0 }), q(h, 'zoomed', { ratio: t, oldRatio: x, originalEvent: r }, { cancelable: !1 })
            }),
            s && this.tooltip()
        }
        return this
      ...
      stop: function () {
        ...
        return (
          this.played &&
            ((t = this.element), I((e = this.options).stop) && X(t, 'stop', e.stop, { once: !0 }), !1 !== q(t, 'stop')) &&
            ((e = this.player),
        ...
        return (
          this.viewed &&
            ...
            this.tooltipping
              ...
              : e.transition
              ? (this.fading && q(i, k), R(i, d), R(i, B), R(i, m), i.removeAttribute('aria-hidden'), (i.initialOffsetWidth = i.offsetWidth), R(i, u))
                    ...
                    (this.length
                      ? this.viewed &&
                        (0 <= (s = o.indexOf(this.index))
                          ...
                          : (R((t = this.items[this.index]), f), t.setAttribute('aria-selected', !0)))
    ...
    At = {
      ...
      shown: function () {
        ...
        ;(this.fulled = !0),
          ...
          !1 !== q(t, 'shown') && this.ready && this.isShown && !this.hiding && this.view(this.index)
      },
      hidden: function () {
        var t = this.element,
          e = this.options,
        ...
        e.fucus && this.clearEnforceFocus(),
          ...
          (this.isShown = !1),
          (this.hiding = !1),
          this.destroyed || (I(e.hidden) && X(t, 'hidden', e.hidden, { once: !0 }), q(t, 'hidden', null, { cancelable: !1 }))
      },
        ...
        (e = [
          {
            ...
            value: function () {
              ...
              s[g] ||
                ...
                (this.images = e),
                this.initBody(),
                D(document.createElement(g).style.transition) && (a.transition = !1),
                a.inline
                  ? ((i = 0),
                    (n = function () {
                      var t
          ...
          },
          {
            ...
            value: function () {
              ...
              this.ready ||
                ...
                (d = (i = d.querySelector('.'.concat(g, '-container'))).querySelector('.'.concat(g, '-title'))),
                ...
                R(d, s.title ? Tt(Array.isArray(s.title) ? s.title[0] : s.title) : v),
                R(m, s.navbar ? Tt(s.navbar) : v),
                F(o, v, !s.button),
                s.keyboard && o.setAttribute('tabindex', 0),
                s.backdrop && (R(i, ''.concat(g, '-backdrop')), s.inline || 'static' === s.backdrop || pt(a, ht, 'hide')),
                T(s.className) &&
                  s.className &&
                  ...
                  ? ((r = document.createElement('ul')),
                    ...
                    A(l ? s.toolbar : ut, function (t, e) {
                      ...
                      !o ||
                        ...
                        I(n) || pt(t, ht, e),
                        E(o) && R(t, Tt(o)),
                        -1 !== ['small', 'large'].indexOf(i) ? R(t, ''.concat(g, '-').concat(i)) : 'play' === e && R(t, ''.concat(g, '-large')),
                        I(n) && X(t, w, n),
                        r.appendChild(t))
                    }),
                    n.appendChild(r))
                ...
                s.inline
                  ? (R(o, U),
                    ...
                    'static' === window.getComputedStyle(e).position && C(e, { position: 'relative' }),
                  ...
                  : (R(o, H),
                    ...
                    R(i, v),
                    C(i, { zIndex: s.zIndex }),
                    (m = (m = T((m = s.container)) ? t.ownerDocument.querySelector(m) : m) || this.body).appendChild(i)),
                s.inline && (this.render(), this.bind(), (this.isShown = !0)),
                (this.ready = !0),
                I(s.ready) && X(t, 'ready', s.ready, { once: !0 }),
                !1 === q(t, 'ready') ? (this.ready = !1) : this.ready && s.inline && this.view(this.index))
            },
          },
        ]) && r(t.prototype, e),
        i && r(t, i),
