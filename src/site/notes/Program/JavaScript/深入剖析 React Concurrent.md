---
{"dg-publish":true,"permalink":"/Program/JavaScript/深入剖析 React Concurrent/","dgPassFrontmatter":true}
---
...
![](/img/user/attchements/media/v2-85024acf40defb83d9e4839fc8ba8c45_720w.jpg)
...
![](/img/user/attchements/media/v2-4b6d2d2212fb3b9bd9bd4b713a38ead7_720w.jpg)
...
!\[](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1752' height='644'></svg>)

### **任务是怎样划分优先级的？**

在 Fiber 早期，曾对优先级有过明确 [定义](https://link.zhihu.com/?target=https%3A//github.com/facebook/react/blob/111731dedd1c8ab2e3033f6ebdac45cb1941cbf7/src/renderers/shared/fiber/ReactPriorityLevel.js)，但后面 [被移除](https://link.zhihu.com/?target=https%3A//github.com/facebook/react/commit/8ac9600574dc4b4445b32b2d7bcba3c9c0bed6f1%23diff-a38905e23ea0948dd00edf42b11f7a41) 了，提出了 [expiration time](https://link.zhihu.com/?target=https%3A//github.com/acdlite/react/commit/3019210df2b486416ed94d7b9becffaf254e81c4%23diff-17ab8416efa473b1aaf1d808dd0c8e15) 的概念。expiration time 顾名思义是过期时间，在 Fiber 中有两层不同的含义，注意区分：
...
-   代表 update 优先级，expiration time 越大，优先级越高，如果你在其它资料中阅读到 expiration time 越小优先级越高，不要感到诧异，因为这块有过 [变更](https://link.zhihu.com/?target=https%3A//github.com/facebook/react/pull/13912)。
...
!\[](data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='1624' height='648'></svg>)

具体 expirationTime 的 [设定](https://link.zhihu.com/?target=https%3A//github.com/facebook/react/blob/v16.8.0/packages/react-reconciler/src/ReactFiberExpirationTime.js)，在 React 内部是这样划分的：
