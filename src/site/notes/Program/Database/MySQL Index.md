...
![斜树](/img/user/z-attchements/media/斜树.png)
...
![AVL 树](/img/user/z-attchements/media/AVL_树.png)
...
![红黑树](/img/user/z-attchements/media/红黑树.png)
...
![主键索引](/img/user/z-attchements/media/主键索引.png)
...
![二级索引](/img/user/z-attchements/media/二级索引.png)
...
![MySQL 表的文件](/img/user/z-attchements/media/MySQL_表的文件.png)

聚簇索引和非聚簇索引:

![聚簇索引和非聚簇索引](/img/user/z-attchements/media/聚簇索引和非聚簇索引.png)
...
![覆盖索引](/img/user/z-attchements/media/覆盖索引.png)
